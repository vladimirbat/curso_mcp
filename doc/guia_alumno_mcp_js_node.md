...
- [4. Agenda recomendada para 2 horas](#4-agenda-recomendada-para-2-horas)
- [5. Requisitos previos](#5-requisitos-previos)
- [Bloque 1. Dónde encaja MCP en el stack de IA para desarrollo](#bloque-1-dónde-encaja-mcp-en-el-stack-de-ia-para-desarrollo)
  - [1.1. Problema que resuelve MCP](#11-problema-que-resuelve-mcp)
  - [1.2. Arquitectura básica](#12-arquitectura-básica)
    - [Host](#host)
    - [Cliente MCP](#cliente-mcp)
    - [Servidor MCP](#servidor-mcp)
  - [1.3. Capas del protocolo](#13-capas-del-protocolo)
    - [Capa de datos](#capa-de-datos)
    - [Capa de transporte](#capa-de-transporte)
  - [1.4. Primitivas principales: tools, resources y prompts](#14-primitivas-principales-tools-resources-y-prompts)
    - [Tools](#tools)
    - [Resources](#resources)
    - [Prompts](#prompts)
  - [1.5. Matriz de decisión rápida](#15-matriz-de-decisión-rápida)
  - [1.6. Ejemplos en el ciclo de desarrollo](#16-ejemplos-en-el-ciclo-de-desarrollo)
    - [Análisis de requisitos](#análisis-de-requisitos)
    - [Diseño UX/UI](#diseño-uxui)
    - [Desarrollo](#desarrollo)
    - [Testing](#testing)
    - [Operación](#operación)
- [Bloque 2. Consumo de MCPs existentes](#bloque-2-consumo-de-mcps-existentes)
  - [2.1. Qué significa consumir un MCP existente](#21-qué-significa-consumir-un-mcp-existente)
  - [2.2. Ejemplos habituales de servidores MCP](#22-ejemplos-habituales-de-servidores-mcp)
  - [2.3. Configuración típica de un servidor local](#23-configuración-típica-de-un-servidor-local)
  - [2.4. Laboratorio 1: probar un servidor filesystem con MCP Inspector](#24-laboratorio-1-probar-un-servidor-filesystem-con-mcp-inspector)
    - [Paso 1. Crear una carpeta segura para pruebas](#paso-1-crear-una-carpeta-segura-para-pruebas)
    - [Paso 2. Ejecutar el servidor con MCP Inspector](#paso-2-ejecutar-el-servidor-con-mcp-inspector)
    - [Paso 3. Inspeccionar capacidades](#paso-3-inspeccionar-capacidades)
    - [Paso 4. Ejecutar una prueba segura](#paso-4-ejecutar-una-prueba-segura)
  - [2.5. Permisos y aprobaciones](#25-permisos-y-aprobaciones)
  - [2.6. Errores habituales al consumir MCPs existentes](#26-errores-habituales-al-consumir-mcps-existentes)
- [Bloque 3. Creación de un MCP propio con Node.js/TypeScript](#bloque-3-creación-de-un-mcp-propio-con-nodejstypescript)
  - [3.1. Qué vamos a construir](#31-qué-vamos-a-construir)
  - [3.2. Estructura del proyecto](#32-estructura-del-proyecto)
  - [3.3. Crear el proyecto](#33-crear-el-proyecto)
  - [3.4. Configurar TypeScript](#34-configurar-typescript)
  - [3.5. Configurar package.json](#35-configurar-packagejson)
  - [3.6. Implementar el servidor MCP](#36-implementar-el-servidor-mcp)
  - [3.7. Compilar](#37-compilar)
  - [3.8. Probar con MCP Inspector](#38-probar-con-mcp-inspector)
  - [3.9. Conectar el servidor a un cliente MCP local](#39-conectar-el-servidor-a-un-cliente-mcp-local)
  - [3.10. Anatomía de una tool MCP](#310-anatomía-de-una-tool-mcp)
    - [1. Qué hace](#1-qué-hace)
    - [2. Qué datos necesita](#2-qué-datos-necesita)
    - [3. Qué devuelve](#3-qué-devuelve)
    - [4. Qué errores pueden ocurrir](#4-qué-errores-pueden-ocurrir)
    - [5. Qué permisos necesita](#5-qué-permisos-necesita)
  - [3.11. Buenas prácticas para diseñar tools](#311-buenas-prácticas-para-diseñar-tools)
  - [3.12. Ejercicios del bloque 3](#312-ejercicios-del-bloque-3)
    - [Ejercicio 1. Añadir una tool de listado](#ejercicio-1-añadir-una-tool-de-listado)
    - [Ejercicio 2. Añadir validación de formato](#ejercicio-2-añadir-validación-de-formato)
    - [Ejercicio 3. Añadir un error de negocio](#ejercicio-3-añadir-un-error-de-negocio)
    - [Ejercicio 4. Añadir una variable de entorno](#ejercicio-4-añadir-una-variable-de-entorno)
- [Bloque 4. Transportes MCP: stdio vs Streamable HTTP](#bloque-4-transportes-mcp-stdio-vs-streamable-http)
  - [4.1. Qué es un transporte](#41-qué-es-un-transporte)
  - [4.2. stdio](#42-stdio)
    - [Cuándo usar stdio](#cuándo-usar-stdio)
    - [Ventajas](#ventajas)
    - [Limitaciones](#limitaciones)
  - [4.3. Streamable HTTP](#43-streamable-http)
    - [Cuándo usar Streamable HTTP](#cuándo-usar-streamable-http)
    - [Ventajas](#ventajas-1)
    - [Riesgos y requisitos](#riesgos-y-requisitos)
  - [4.4. Comparativa rápida](#44-comparativa-rápida)
  - [4.5. No confundir Streamable HTTP con REST](#45-no-confundir-streamable-http-con-rest)
- [Bloque 5. Seguridad y operación básica](#bloque-5-seguridad-y-operación-básica)
  - [5.1. Por qué la seguridad importa en MCP](#51-por-qué-la-seguridad-importa-en-mcp)
  - [5.2. Principio de mínimo privilegio](#52-principio-de-mínimo-privilegio)
  - [5.3. Gestión de secretos](#53-gestión-de-secretos)
  - [5.4. Logs](#54-logs)
  - [5.5. Límites operativos](#55-límites-operativos)
  - [5.6. Aprobación de acciones](#56-aprobación-de-acciones)
  - [5.7. Checklist de seguridad para una tool MCP](#57-checklist-de-seguridad-para-una-tool-mcp)
  - [5.8. Checklist de operación](#58-checklist-de-operación)
- [Actividad final: diseñar un MCP para un caso real](#actividad-final-diseñar-un-mcp-para-un-caso-real)
- [Glosario](#glosario)
- [Resumen para recordar](#resumen-para-recordar)
- [Referencias oficiales](#referencias-oficiales)
- [Anexo A. Plantilla para diseñar una tool MCP](#anexo-a-plantilla-para-diseñar-una-tool-mcp)
  - [Nombre de la tool](#nombre-de-la-tool)
  - [Objetivo](#objetivo)
  - [Usuario objetivo](#usuario-objetivo)
  - [Cuándo debe invocarse](#cuándo-debe-invocarse)
  - [Cuándo no debe invocarse](#cuándo-no-debe-invocarse)
  - [Input schema](#input-schema)
  - [Output esperado](#output-esperado)
  - [Errores recuperables](#errores-recuperables)
  - [Permisos](#permisos)
  - [Seguridad](#seguridad)
  - [Observabilidad](#observabilidad)
- [Anexo B. Plantilla de configuración local](#anexo-b-plantilla-de-configuración-local)
- [Anexo C. Comandos útiles](#anexo-c-comandos-útiles)
- [Anexo D. Preguntas de autoevaluación](#anexo-d-preguntas-de-autoevaluación)
- [Anexo E. Soluciones orientativas de autoevaluación](#anexo-e-soluciones-orientativas-de-autoevaluación)
